...
Type conversion overview:
	...
	typedef char GLchar;             -> u8 //This is wrong??
...
GLdebugproc :: debug_proc_t;

GLstring	:: cstring;
GLoutstring :: [^]u8;

sync_t :: distinct rawptr
debug_proc_t :: #type proc "c" (source: GLenum, type: GLenum, id: GLuint, severity: GLenum, length: GLsizei, message: cstring, user_param : rawptr)


impl_intptr :: int;
impl_uintptr :: uintptr;
...
impl_GetVertexAttribPointerv:  proc "c" (index: u32, pname: u32, pointer: ^impl_uintptr)
...
impl_VertexAttribPointer:      proc "c" (index: u32, size: i32, type: u32, normalized: bool, stride: i32, pointer: impl_uintptr)
...
impl_VertexAttribIPointer:                proc "c" (index: u32, size: i32, type: u32, stride: i32, pointer: impl_uintptr)
...
impl_VertexAttribLPointer:      proc "c" (index: u32, size: i32, type: u32, stride: i32, pointer: impl_uintptr)
...
impl_GetProgramResourceName:          proc "c" (program: u32, programInterface: u32, index: u32, bufSize: i32, length: ^i32, name: cstring)
...
impl_BindBuffersRange:  proc "c" (target: u32, first: u32, count: i32, buffers: [^]u32, offsets: [^]impl_intptr, sizes: [^]int)
...
impl_BindVertexBuffers: proc "c" (first: u32, count: i32, buffers: [^]u32, offsets: [^]impl_intptr, strides: [^]i32)
...
impl_VertexArrayVertexBuffers:                 proc "c" (vaobj: u32, first: u32, count: i32, buffers: [^]u32, offsets: [^]impl_intptr, strides: [^]i32)
