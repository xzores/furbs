...
foreign lib {
	...
	v8_context_in_context :: proc () -> b32 ---
	...
	v8_value_create_bool :: proc (value: b32) -> ^V8_value ---

	/// Create a new V8_value object of type int.
	v8_value_create_int :: proc (value: i32) -> ^V8_value ---

	/// Create a new V8_value object of type unsigned int.
	v8_value_create_uint :: proc (value: u32) -> ^V8_value ---

	/// Create a new V8_value object of type double.
	v8_value_create_double :: proc (value: f64) -> ^V8_value ---
	...
	v8_value_create_date :: proc (date: Basetime) -> ^V8_value ---

	/// Create a new V8_value object of type string.
	v8_value_create_string :: proc (value: ^cef_string) -> ^V8_value ---
	...
	/// v8_accessor callback, or in combination with calling enter() and exit()
	/// on a stored V8_context reference.
	v8_value_create_array :: proc (length: c.int) -> ^V8_value ---
	...
	/// v8_accessor callback, or in combination with calling enter() and exit()
	/// on a stored V8_context reference.
	v8_value_create_array_buffer :: proc (buffer: rawptr, length: c.size_t, release_callback: ^v8_array_buffer_release_callback) -> ^V8_value ---
	...
	v8_value_create_array_buffer_with_copy :: proc (buffer: rawptr, length: c.size_t) -> ^V8_value ---
	...
	/// v8_accessor callback, or in combination with calling enter() and exit()
	/// on a stored V8_context reference.
	v8_value_create_function :: proc (name: ^cef_string, handler: ^V8_handler) -> ^V8_value ---
	...
	@(link_name="cef_v8_stack_trace_get_current")
	v8_get_current_stack_trace :: proc (frame_limit: c.int) -> ^V8_stack_trace ---
	...
	register_extension :: proc (extension_name: ^cef_string, javascript_code: ^cef_string, handler: ^V8_handler) -> b32 ---
}
