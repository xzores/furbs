...
sock_open_fn :: #type proc "contextless" (sock : ws_socket_handle)
sock_recv_fn :: #type proc "contextless" (sock : ws_socket_handle, kind : Data_kind, data : [^]u8, length : int)
sock_error_fn :: #type proc "contextless" (sock : ws_socket_handle)
sock_close_fn :: #type proc "contextless" (sock : ws_socket_handle)
...
@(default_calling_convention="contextless", private="file")
foreign odin_env {
