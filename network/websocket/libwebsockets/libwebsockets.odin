...
lws_context_creation_info :: struct {
    port : c.int,								/* listen port, or CONTEXT_PORT_NO_LISTEN */
    iface : cstring,							/* NULL = any */
    protocols : [^]lws_protocols,				/* your protocols array (NULL-terminated) */
    vhost_name : cstring,						/* eg "default" */
    user : rawptr, 								/* ctx user pointer (optional) */
    options : c.int, 							/* 0 unless you need special flags */
    gid, uid : c.int, 							/* 0 */
    ka_time, ka_probes, ka_interval : c.int,	/* 0 (keepalive off) */
