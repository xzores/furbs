...
// VERSION_1_0
	 ...
	 TexImage1D :: proc "c" (target : GLenum, level : GLint, internalformat : GLint, width : GLsizei, border : GLint, format : GLenum, type : GLenum, pixels : rawptr, loc := #caller_location) { impl_TexImage1D(cast(u32)target, level, internalformat, width, border, cast(u32)format, cast(u32)type, pixels); debug_helper(loc, nil, target, level, internalformat, width, border, format, type, pixels); };
	 TexImage2D :: proc "c" (target : GLenum, level : GLint, internalformat : GLint, width : GLsizei, height : GLsizei, border : GLint, format : GLenum, type : GLenum, pixels : rawptr, loc := #caller_location) { impl_TexImage2D(cast(u32)target, level, internalformat, width, height, border, cast(u32)format, cast(u32)type, pixels); debug_helper(loc, nil, target, level, internalformat, width, height, border, format, type, pixels); };
...
// VERSION_1_2
	 ...
	 TexImage3D :: proc "c" (target : GLenum, level : GLint, internalformat : GLint, width : GLsizei, height : GLsizei, depth : GLsizei, border : GLint, format : GLenum, type : GLenum, pixels : rawptr, loc := #caller_location) { impl_TexImage3D(cast(u32)target, level, internalformat, width, height, depth, border, cast(u32)format, cast(u32)type, pixels); debug_helper(loc, nil, target, level, internalformat, width, height, depth, border, format, type, pixels); };
...
// VERSION_1_0
	 ...
	 TexImage1D :: proc "c" (target : GLenum, level : GLint, internalformat : GLint, width : GLsizei, border : GLint, format : GLenum, type : GLenum, pixels : rawptr) { impl_TexImage1D(cast(u32)target, level, internalformat, width, border, cast(u32)format, cast(u32)type, pixels); };
	 TexImage2D :: proc "c" (target : GLenum, level : GLint, internalformat : GLint, width : GLsizei, height : GLsizei, border : GLint, format : GLenum, type : GLenum, pixels : rawptr) { impl_TexImage2D(cast(u32)target, level, internalformat, width, height, border, cast(u32)format, cast(u32)type, pixels); };
...
// VERSION_1_2
	 ...
	 TexImage3D :: proc "c" (target : GLenum, level : GLint, internalformat : GLint, width : GLsizei, height : GLsizei, depth : GLsizei, border : GLint, format : GLenum, type : GLenum, pixels : rawptr) { impl_TexImage3D(cast(u32)target, level, internalformat, width, height, depth, border, cast(u32)format, cast(u32)type, pixels); };
